  ...
  <?php
        ...
        ?>
              ...
              <div class="auth-form-light text-left p-5">
                ...
                <h4>Halo! Selamat datang di <b>Srikandi </b></h4>
                ...
                <form class="pt-3"  action="<?= base_url('login/login'); ?>" method="post">
                  ...
                  <div class="text-center mt-4 font-weight-light"> Tidak punya akun? <a href="<?= base_url('login/register')?>" class="text-primary">Daftar</a>
                  </div>
                </form>
              </div>
            </div>
